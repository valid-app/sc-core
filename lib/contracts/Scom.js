...
class Scom extends eth_wallet_1.Contract {
    constructor(wallet, address) {
        super(wallet, address, Scom_json_1.default.abi, Scom_json_1.default.bytecode);
        this.assign();
    }
    deploy(params) {
        return this.__deploy([params.minter, params.initSupplyTo, eth_wallet_1.Utils.toString(params.initSupply), eth_wallet_1.Utils.toString(params.totalSupply)]);
    }
