...
class ProjectInfo extends eth_wallet_1.Contract {
    ...
    decodeNewPackageVersionEvent(event) {
        ...
        return {
            ...
            version: {
                major: new eth_wallet_1.BigNumber(result.version.major),
                minor: new eth_wallet_1.BigNumber(result.version.minor),
                patch: new eth_wallet_1.BigNumber(result.version.patch)
            },
            _event: event
        };
    }
    ...
    assign() {
        ...
        let projectBackerBalanceParams = (params) => [params.param1, eth_wallet_1.Utils.toString(params.param2)];
        ...
        let projectBalance_call = async (param1) => {
            let result = await this.call('projectBalance', [eth_wallet_1.Utils.toString(param1)]);
            return new eth_wallet_1.BigNumber(result);
        };
        ...
        let newPackageVersionParams = (params) => [eth_wallet_1.Utils.toString(params.projectId), eth_wallet_1.Utils.toString(params.packageId), [eth_wallet_1.Utils.toString(params.version.major), eth_wallet_1.Utils.toString(params.version.minor), eth_wallet_1.Utils.toString(params.version.patch)], params.ipfsCid];
        ...
        let setPackageVersionToAuditFailedParams = (params) => [eth_wallet_1.Utils.toString(params.packageVersionId), params.reportUri];
        ...
        let setPackageVersionToAuditPassedParams = (params) => [eth_wallet_1.Utils.toString(params.packageVersionId), params.reportUri];
        ...
        let stakeParams = (params) => [eth_wallet_1.Utils.toString(params.projectId), eth_wallet_1.Utils.toString(params.amount)];
        ...
        let unstakeParams = (params) => [eth_wallet_1.Utils.toString(params.projectId), eth_wallet_1.Utils.toString(params.amount)];
